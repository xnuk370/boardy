...
<?php endif; ?>
    ...
    <a href="<?php echo e(route('auth.github')); ?>" 
       style="background-color: #24292e; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block;">
        Войти через GitHub
    </a>
</div>
    </form>
...
<?php endif; ?>
<?php /**PATH /home/student/boardy/src/boardy-laravel/resources/views/auth/login.blade.php ENDPATH**/ ?>